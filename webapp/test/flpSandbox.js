		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "RNC Fornecedor",
									"targetURL": "#cominbettarncfornecedor-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"cominbettarncfornecedor-display": {
								"semanticObject": "cominbettarncfornecedor",
								"action": "display",
								"description": "Plano de Ação Nota QM Fornecedor",
								"title": "RNC Fornecedor",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.inbetta.rncfornecedor",
									"url": sap.ui.require.toUrl("com/inbetta/rncfornecedor")
								}
							}
						}
					}
